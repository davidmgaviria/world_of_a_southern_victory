...
--NDefines.NProduction.BASE_FACTORY_SPEED = 5						    -- vanilla is 5
--NDefines.NProduction.BASE_FACTORY_SPEED_MIL = 4					    -- vanilla is 4.5
NDefines.NCountry.DEFAULT_WAR_SUPPORT = 0.2							-- vanilla is 0.5
NDefines.NCountry.BASE_STABILITY_WAR_FACTOR = -0.1                  -- vanilla is 0.2
...
-- Major
NDefines.NCountry.ADDITIONAL_MAJOR_COUNTRIES_IC_RATIO = 0.8         -- vanilla is 0.7 (dont want any random idiot being a major)       
NDefines.NCountry.MAJOR_MIN_FACTORIES = 50						    -- vanilla is 35 (dont want any random idiot being a major)

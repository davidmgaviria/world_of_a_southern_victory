...
--NDefines.NAI.DESIRE_USE_XP_TO_UNLOCK_AIR_DOCTRINE = 0.6     -- How quickly is desire to unlock air doctrines accumulated?

NDefines.NAI.START_TRAINING_EQUIPMENT_LEVEL = 0.8               -- ai will not start to train if equipment drops below this level
NDefines.NAI.STOP_TRAINING_EQUIPMENT_LEVEL = 0.75                -- ai will not train if equipment drops below this level
